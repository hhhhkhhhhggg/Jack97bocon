...
shared.LoaderTitle = "Trungkhoaito Jack97bocon";
...
local v16 = {
    Home = v15:AddTab({
        Title = "Thông Tin(jackbocoin)"
    }),
    Main = v15:AddTab({
        Title = "Cày(jackbocoin)"
    }),
    Sea = v15:AddTab({
        Title = "Sự Kiện(jackbocoin)"
    }),
    ITM = v15:AddTab({
        Title = "Vật Phẩm(jackbocoin)"
    }),
    Setting = v15:AddTab({
        Title = "Cài Đặt(jackbocoin)"
    }),
    Status = v15:AddTab({
        Title = "Máy Chủ(jackbocoin)"
    }),
    Stats = v15:AddTab({
        Title = "Chỉ Số(2.5củ)"
    }),
    Player = v15:AddTab({
        Title = "Người Chơi(2.5củ)"
    }),
    Teleport = v15:AddTab({
        Title = "Dịch Chuyển(bocoin"
    }),
    Visual = v15:AddTab({
        Title = "Phong bạc"
    }),
